...
我做 **Panel 058**，就是想解决这个别扭。它不是给照片硬套模板，而是先认出照片里真正不能丢的东西，再把它翻译成：**用严谨几何读懂照片的潜台词，把现实重构为诗意的观念景观**。
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 058 样张 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 058 样张 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 058 样张 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 058 样张 8"></td>
  </tr>
</table>

> [小小东（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092176222445035612) · 2026 年 8 月 25 日<br>
> GPT2 × 几何 × 抽象 × 灵魂 × 美学提示词 × VOL.058

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612">查看原推文与完整提示词 →</a></p>

这些样张只展示 058 的审美结果；样张主体、构图、配色、文字和旧画幅不会成为新任务的参考或默认值。

潜台词解读 · 几何极简 · 观念景观 · 柔和手工质感 · 淡色留白

它先判断照片没有直接说出的去向、距离、等待、离开或靠近，再把这些关系提炼为路径、地貌、建筑体和象征形体。理性的比例、轴线与空间秩序约束着柔和手工质感，让普通照片长出一层安静、浪漫而可读的寓言。
...
这套风格不止识别照片里“有什么”，还会寻找它在暗示什么、象征什么以及让人联想到什么。它保留最有意味的主体与关系，删去复杂背景，再用少量形体、路径、距离与空间层次搭建一个与原图同源的观念场景。

```text
锁定身份、轮廓与姿态 → 读出潜台词、情绪和寓意 → 删除无关现实细节 → 提炼核心主题与象征关系 → 用形体、路径、轴线、透视和距离搭建观念景观 → 以淡色留白和柔和手工质感保持诗意 → 融入极少且真正相关的文字
```

## 成品中最容易识别的风格特点

- 原图的主体与关系被转化为山体、建筑、道路、平台、穹顶、圆盘或其他少量象征形体，而不是完整描摹现实。
- 比例、轴线、透视、路径引导、块面关系与空间平衡共同建立严谨的理性结构。
- 浅粉蓝、雾蓝、天空蓝、象牙白、奶油白与少量柔粉点色，在大面积近白留白中形成通透层次。
- 轻微纸感、粉感或版画感让几何平面保持柔和手工气息，避开贴纸、写实与光滑 3D。
- 文字像独立刊物中的题签或观察性注记，沿轴线、路径、边缘或主体周围轻量出现。

原始审美约束与拒绝项只存在于[原始提示词](references/original-prompt/zh-CN.md)；Skill 与运行适配器只处理本次交付变量。 [Skill 工作流](SKILL.md) · [英文运行适配器](references/xxd-panel-058-prompt.en.md)
