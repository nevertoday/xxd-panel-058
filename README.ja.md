...
# 🦁 XXD Panel 058｜詩的コンセプト風景

### 写真の潜台詞を読み取り、厳密な幾何学で詩的なコンセプト風景へ再構成
...
<table>
  <tr>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 058 作例 1"></a></td>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 058 作例 2"></a></td>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 058 作例 3"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 058 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 058 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 058 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 058 作例 8"></td>
  </tr>
</table>

## 追加 3:4 上下構成作例

上の 16:9 作例と同じ4点の独立素材を、完全な 3:4 上下構成として再生成しました。上部は現実の写真を保ち、下部は Panel 058 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 058 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 058 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 058 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 058 追加上下作例 4"></td>
  </tr>
</table>

> [小小東（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092176222445035612) · 2026年8月25日<br>
> GPT2 × 幾何 × 抽象 × 魂 × 美学プロンプト × VOL.058

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612">元の投稿と完全なプロンプトを見る →</a></p>

これらの作例は 058 の美的成果だけを示します。作例の被写体、構図、配色、文字、旧キャンバス比率が、新しいタスクの参照や既定値になることはありません。

潜台詞の読解 · 幾何学的ミニマリズム · コンセプト風景 · 柔らかな手仕事感 · 淡い余白

写真が直接語らない行き先、距離、待つこと、離れること、近づくことを読み取り、それらの関係を道、地形、建築体、象徴的な形へ翻訳します。理性的な比率、軸線、空間秩序が柔らかな手仕事の質感を支え、何気ない写真から静かでロマンチックな寓話が立ち上がります。
...
**Panel 058** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真の潜台詞を読み取り、厳密な幾何学で詩的なコンセプト風景へ再構成**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 058 でこの画像を処理して、まず最適な構図とサイズを提案して。
...
## すぐに判断：XXD Panel 058 はあなたに合う？

| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 写真の潜台詞を読み取り、厳密な幾何学で詩的なコンセプト風景へ再構成 |
| **ひと目で分かる特徴** | 潜台詞の読解 · 幾何学的ミニマリズム · コンセプト風景 · 柔らかな手仕事感 · 淡い余白 |
...
目に見える物だけでなく、写真が何を暗示し、象徴し、連想させるかを読みます。意味のある主体と関係を残し、説明的な細部を減らし、少数の形、道、距離、空間層から元写真と同源の観念的な場面を組み立てます。

```text
同一性・輪郭・姿勢を固定 → 潜台詞・感情・寓意を読む → 無関係な現実の細部を削る → 中心テーマと象徴関係を抽出 → 形・道・軸線・透視・距離でコンセプト風景を構築 → 淡い余白と柔らかな手仕事感で詩情を保つ → 元写真に結びつく最小限の文字を統合
```

## 完成作品で見分けやすいスタイル特性

- 主体と関係は山、建築、道路、台、ドーム、円盤など少数の象徴形へ変換され、現実の全景をなぞりません。
- 比率、軸線、遠近法、経路誘導、面の関係、空間バランスが厳密な理性の秩序を作ります。
- 淡いピンクブルー、霧の青、空色、象牙色、クリーム色、少量のブラッシュが白に近い余白の中で透き通る層を作ります。
- わずかな紙感、粉感、版画感が幾何面に柔らかな手仕事の気配を残し、ステッカー感、写実、滑らかな 3D を避けます。
- 文字は独立刊行物の題簽や観察メモのように、軸線、経路、縁、主体の周囲へ軽く配置されます。

美的制約と拒否項目は[原文プロンプト](references/original-prompt/zh-CN.md)だけにあり、Skill とランタイムアダプターは今回の出力変数だけを扱います。 [Skill](SKILL.md) · [英語ランタイムアダプター](references/xxd-panel-058-prompt.en.md)
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 058 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-058 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP
...
/xxd-panel-058 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-058 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-058 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 058 を適用し、共通設定は一度だけ解決
/xxd-panel-058 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
...
Claude Code では同じフォルダを次へリンクできます： `~/.claude/skills/xxd-panel-058`. インストール後に Agent セッションを再起動してください。
...
完全仕様: [Skill ワークフロー](SKILL.md) · [原始スタイル資料](references/original-prompt/zh-CN.md) · [英語ランタイムアダプター](references/xxd-panel-058-prompt.en.md) · [中国語ランタイムアダプター](references/xxd-panel-058-prompt.zh-CN.md)
