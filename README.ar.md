...
# 🦁 XXD Panel 058｜مشهد مفاهيمي شاعري

### قراءة ما لا تقوله الصورة ثم إعادة بنائه كمشهد مفاهيمي شاعري بهندسة صارمة
...
<table>
  <tr>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 058 نموذج 1"></a></td>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 058 نموذج 2"></a></td>
    <td width="33.33%"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 058 نموذج 3"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 058 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 058 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 058 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 058 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 058. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 058 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 058 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 058 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 058 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2092176222445035612) · 25 أغسطس 2026<br>
> GPT2 × هندسة × تجريد × روح × موجّه جمالي × VOL.058

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092176222445035612">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 058 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.

قراءة المعنى الضمني · بساطة هندسية · مشهد مفاهيمي · ملمس يدوي ناعم · فراغات فاتحة

يقرأ أولاً ما تتركه الصورة من دون تصريح: الاتجاه والمسافة والانتظار والرحيل والاقتراب، ثم يترجم هذه العلاقات إلى مسارات وتضاريس وكتل معمارية وأشكال رمزية. تضبط النسب والمحاور والنظام المكاني ملمساً يدوياً رقيقاً، فتنمو من الصورة العادية حكاية هادئة ورومانسية وقابلة للقراءة.
...
يناسب **Panel 058** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **قراءة ما لا تقوله الصورة ثم إعادة بنائه كمشهد مفاهيمي شاعري بهندسة صارمة**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 058 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 058 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | قراءة ما لا تقوله الصورة ثم إعادة بنائه كمشهد مفاهيمي شاعري بهندسة صارمة |
| **السمات التي تُعرف من النظرة الأولى** | قراءة المعنى الضمني · بساطة هندسية · مشهد مفاهيمي · ملمس يدوي ناعم · فراغات فاتحة |
...
لا يكتفي الأسلوب بما يظهر في الصورة، بل يبحث عما توحي به وترمز إليه وتستدعيه. يحتفظ بالموضوعات والعلاقات الأشد معنى، ويزيل التفاصيل الوصفية الزائدة، ثم يبني مشهداً مفاهيمياً مرتبطاً بالمصدر من عدد قليل من الأشكال والمسارات والمسافات والطبقات المكانية.

```text
تثبيت الهوية والهيئة والوضع ← قراءة المعنى الضمني والعاطفة والدلالة ← حذف التفاصيل الواقعية غير المهمة ← استخلاص الفكرة المركزية والعلاقة الرمزية ← بناء مشهد مفاهيمي بالشكل والمسار والمحور والمنظور والمسافة ← حفظ الشعرية بالفراغ الفاتح والملمس اليدوي الناعم ← دمج أقل قدر من النص المرتبط بالمصدر
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- تتحول الموضوعات والعلاقات إلى جبال ومبانٍ وطرق ومنصات وقباب وأقراص أو بضعة أشكال رمزية أخرى، بدلاً من نسخ المشهد الواقعي كاملاً.
- تصنع النسب والمحاور والمنظور وتوجيه المسار وعلاقات المساحات والتوازن المكاني نظاماً عقلانياً صارماً.
- تتنفس ألوان الأزرق الوردي الفاتح والضبابي والسماوي والعاجي والكريمي مع لمسات وردية قليلة داخل مساحة واسعة قريبة من الأبيض.
- يمنح ملمس الورق أو المسحوق أو الطباعة الخفيف الأشكال الهندسية نعومة يدوية، بعيداً عن الملصقات والواقعية والـ3D المصقول.
- تظهر الكلمات كملاحظات رصدية أو عناوين صغيرة في منشور فني مستقل، وتتبع بخفة المحاور والمسارات والحواف أو الموضوع.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-058-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 058. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-058 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-058 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-058 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-058 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-058 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 058 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-058 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-058`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-058-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-058-prompt.zh-CN.md)
